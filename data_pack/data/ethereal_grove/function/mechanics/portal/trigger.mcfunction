...
execute if dimension minecraft:overworld positioned ~1 ~ ~1 in ethereal_grove:ethereal_grove run function ethereal_grove:mechanics/portal/create_portal
execute if dimension ethereal_grove:ethereal_grove positioned ~1 ~ ~1 in minecraft:overworld run function ethereal_grove:mechanics/portal/create_portal
...
function ethereal_grove:mechanics/portal/teleport with entity @s data."ethereal_grove:target"
