...
execute align xyz positioned ~0.5 ~0.5 ~0.5 run summon item_display ~ ~ ~ {item:{id:"diamond_ore",components:{"item_model":"ethereal_grove:portal"}},Tags:["smithed.entity", "smithed.strict", "ethereal_grove.portal"],brightness:{block:11,sky:7}}
