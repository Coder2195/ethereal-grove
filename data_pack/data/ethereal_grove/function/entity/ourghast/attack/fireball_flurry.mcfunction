...
execute positioned ^2 ^2 ^5 run function ethereal_grove:entity/ourghast/attack/fireball_flurry/summon with storage ethereal_grove:temp ourghast_fireball
execute positioned ^0 ^2 ^5 run function ethereal_grove:entity/ourghast/attack/fireball_flurry/summon with storage ethereal_grove:temp ourghast_fireball
execute positioned ^-2 ^2 ^5 run function ethereal_grove:entity/ourghast/attack/fireball_flurry/summon with storage ethereal_grove:temp ourghast_fireball
