...
execute as @e[type=item_display,tag=ethereal_grove.ourghast.teardrop_exploder] unless predicate ethereal_grove:entity/on_vehicle at @s run function ethereal_grove:entity/ourghast/attack/teardrop/explode with entity @s data."ethereal_grove:owner"
