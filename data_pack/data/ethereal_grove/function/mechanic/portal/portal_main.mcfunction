...
execute if score @s ethereal_grove.success matches 1.. positioned ~-7 -64 ~-7 unless entity @p[dx=16,dy=382,dz=16] in ethereal_grove:ethereal_grove unless entity @p[dx=16,dy=382,dz=16] run function ethereal_grove:mechanic/portal/remove_forceload
